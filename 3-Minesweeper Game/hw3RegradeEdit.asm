...
load_map.storeArray:
	la $t5, cells_array		# Load address of array
...
# Calculate adjacent bombs
	...
	la $t0, cells_array		# Address cursor
	la $t1, cells_array + 400	# Base case
...
load_map.adjacent:
	...
	adj.cornerA: #(1)
		la $t5, cells_array + 4		# Cell 2
		jal addBomb			# Check bomb
		
		la $t5, cells_array + 40	# Cell 11
		jal addBomb			# Check bomb
		
		la $t5, cells_array + 44	# Cell 12
		jal addBomb			# Check bomb
	...
	adj.cornerB: #(10)
		li $t3, -4
		la $t5, cells_array($t3)	# Cell 9
		jal addBomb			# Check bomb
		
		la $t5, cells_array + 40	# Cell 20
		jal addBomb			# Check bomb
		
		la $t5, cells_array + 36	# Cell 19
		jal addBomb			# Check bomb
	...
	adj.cornerC: #(91)
		li $t3, -40
		la $t5, cells_array($t3)	# Cell 81
		jal addBomb			# Check bomb
		
		li $t3, -36
		la $t5, cells_array($t3)	# Cell 82
		jal addBomb			# Check bomb
		
		la $t5, cells_array + 4		# Cell 92
		jal addBomb			# Check bomb
	...
	adj.cornerD: #(100)
		li $t3, -40
		la $t5, cells_array($t3)	# Cell 90
		jal addBomb			# Check bomb
		
		li $t3, -44
		la $t5, cells_array($t3)	# Cell 89
		jal addBomb			# Check bomb
		
		li $t3, -4
		la $t5, cells_array($t3)	# Cell 99
		jal addBomb			# Check bomb
		
		j adj.advance
	
	adj.topEdge:
		la $t5, cells_array + 4		# Cell +1
		jal addBomb			# Check bomb
		
		la $t5, cells_array + 44	# Cell +11
		jal addBomb			# Check bomb
		
		la $t5, cells_array + 40	# Cell +10
		jal addBomb			# Check bomb
		
		la $t5, cells_array + 36	# Cell +9
		jal addBomb			# Check bomb
		
		li $t3, -4
		la $t5, cells_array($t3)	# Cell -1
		jal addBomb			# Check bomb
	...
	adj.botEdge:
		...
		li $t3, -44
		la $t5, cells_array($t3)	# Cell -11
		jal addBomb			# Check bomb
		
		li $t3, -40
		la $t5, cells_array($t3)	# Cell -10
		jal addBomb			# Check bomb
	...
	adj.mid:
		...
		la $t5, cells_array +11		# Cell +11
		jal addBomb			# Check bomb
		
		la $t5, cells_array +10		# Cell +10
		jal addBomb			# Check bomb
...
la $t0, cells_array + 100	# 9 CHANGEs
la $t2, cells_array
move $t3, $a1
arrayCopy:
lb $t1, ($t2)
...
reveal_map.lost:
	...
	li $a0, 0
	li $a1, 0
	move $t8, $t0 	#array address counter		# 1 CHANGE
	move $t9, $ra
...
cursor_row: .word -1
cursor_col: .word -1
cells_array: .space 100 # 1 CHANGE
buffer: .byte 1
